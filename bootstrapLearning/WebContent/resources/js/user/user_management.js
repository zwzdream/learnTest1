...
/*	 $('#button').click(function () {
		 $('#reportTable').bootstrapTable('refresh', {url: ctx+'/User/username/listPage'});
     });*/
	//boolbar按钮的click响应事件
/*	$("#btn_edit").click(function(){
		var rowsId = getIdSelections();
		alert();
		var id=parseInt(rowsId);
...
function searchName(){
 ...
 method: 'post',
  //method: 'get',
 url: ctx+'/User/username/listPage',
...
// responseHandler: responseHandler,//对后台传的数据处理成前台可以接受的形式
 ...
 columns: [
	 ...
	 {field:'username',title:'用户名',width:100,sortable:true,valign:'middle',align:'center'},
	 {field:'password',title:'密码',width:100,sortable:true,valign:'middle',align:'center'},
	 {field:'mail',title:'邮箱',width:100,sortable:true,valign:'middle',align:'center'},
	 {field:'telphone',title:'电话',width:100,sortable:true,valign:'middle',align:'center'},
	 {field:'permission',title:'权限',width:100,sortable:true,valign:'middle',align:'center'},
	 {field:'date',title:'日期',width:100,sortable:true,valign:'middle',align:'center'},
