...
<link rel="stylesheet" href="${ctx}/resources/js/user/bootstrap-table/bootstrap-table.css">
<script src="${ctx}/resources/js/user/bootstrap-table/bootstrap-table.js"></script>
<script src="${ctx}/resources/js/user/bootstrap-table/bootstrap-table-zh-CN.js"></script>
<script src="${ctx}/resources/js/user/bootstrap-table/bootstrap-table-toolbar.js"></script>
<script src="${ctx}/resources/js/user/bootstrapTableExample.js"></script>
